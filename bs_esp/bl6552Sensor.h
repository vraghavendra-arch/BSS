 ...
 * Voltage constants will be same for all our boards
 * Current and Power (Active, Reactive and Apparent) constants will change with change of CTs.
 * CTs that we have with us:
 * 1. 100 Amps , 2500 Turns CT
 * 2. 100 Amps , 2000 Turns CT
 * 
 * Table of calibration constants
 * 
  | CT type      | Constant Para  | Standard Value | K Constant |
  |--------------|----------------|----------------|------------|
  | 100A, 2500:1 | CURRENT        | 0.8000         | 51372      |
  |              | ACTIVE POWER   | 106.2230       | 17001.6667 |
  |              | APPARENT POWER | 106.4017       | 17050.3333 |
  |              |                |                |            |
  | 100A, 2000:1 | CURRENT        | 2.19           | 1741332    |
  |              | ACTIVE POWER   | 519.525096     | 102790.00  |
  |              | APPARENT POWER | 520.5567       | 103178.333 |
  |              |                |                |            |
 * 
*/
#ifndef VOLTAGE_STANDARD_VALUE
#define VOLTAGE_STANDARD_VALUE    239.6333
#endif

#ifndef VOLTAGE_K_CONSTANT
#define VOLTAGE_K_CONSTANT        2502632.33
#endif

#ifndef VOLTAGE_CONSTANT
#define VOLTAGE_CONSTANT          VOLTAGE_STANDARD_VALUE/VOLTAGE_K_CONSTANT
#endif

#ifndef CURRENT_STANDARD_VALUE
#define CURRENT_STANDARD_VALUE    0.8567 //2.19//8.00//0.8000
#endif

#ifndef CURRENT_K_CONSTANT
#define CURRENT_K_CONSTANT        54374.33 //174132.0//638679.0//51372
#endif

#ifndef CURRENT_CONSTANT
#define CURRENT_CONSTANT          CURRENT_STANDARD_VALUE/CURRENT_K_CONSTANT
#endif

#ifndef ACTIVE_POWER_STANDARD_VALUE
#define ACTIVE_POWER_STANDARD_VALUE 201.3627 //519.525096//1955.12
#endif

#ifndef ACTIVE_POWER_K_CONSTANT
#define ACTIVE_POWER_K_CONSTANT    31764.00 //102790.00//388261.00
#endif

#ifndef ACTIVE_POWER_CONSTANT
#define ACTIVE_POWER_CONSTANT      ACTIVE_POWER_STANDARD_VALUE/ACTIVE_POWER_K_CONSTANT
#endif

#ifndef APPARENT_POWER_STANDARD_VALUE
#define APPARENT_POWER_STANDARD_VALUE 203.3967 //520.5567//1955
#endif

#ifndef APPARENT_POWER_K_CONSTANT
#define APPARENT_POWER_K_CONSTANT    31843.3333 //103178.333//388732.00
#endif

#ifndef APPARENT_POWER_CONSTANT
#define APPARENT_POWER_CONSTANT      APPARENT_POWER_STANDARD_VALUE/APPARENT_POWER_K_CONSTANT
#endif

//Communication command data
#define BL6552_UART_BAUD               4800
#define BL6552_DEFAULT_PORT_CONFIG     SERIAL_8N1

#define BL6552_READ_CMD   0x35
#define BL6552_WRITE_CMD  0xCA

#define BL6552_TIMEOUT    50 //ms
#define BL6552_MAX_FRAME  16

#define BL6552_HEAD_POSE     0
#define BL6552_ADD_POSE      1
#define BL6552_DATA_L_POSE   2
#define BL6552_DATA_M_POSE   3
#define BL6552_DATA_H_POSE   4
#define BL6552_CRC_POSE      5

#define COEFFICIENT_TYPE_CURRENT  1
#define COEFFICIENT_TYPE_VOLTAGE  2
#define COEFFICIENT_TYPE_ACTIVE_POWER  3
#define COEFFICIENT_TYPE_APPARENT_POWER  4

#define STANDERED_VOLTAGE_VALUE 230 // [TODO] need to see this value
#define BL6552_ERROR  -254
...
typedef struct
{
    uint8_t Bytes;
    uint8_t Index;
    uint8_t Payload[BL6552_MAX_FRAME];
    uint64_t lastRcv;
    uint64_t lastUpdate;
} frame_t;
...
{
    public:
        BL6552(HardwareSerial* hwSer); // Constructor
        ~BL6552(); // Destructor
        ...
        float getPhaseAngleOfPhase(int phase);
        ...
        void setAllConstants(float iS, float iK, float vS, float vK, float pS, float pK, float sS, float sK);
        void setCurrentConstant(float iS, float iK);
        void setVoltageConstant(float vS, float vK);
        void setActivePowerConstant(float pS, float pK);
        void setApparentPowerConstant(float sS, float sK);
    ...
    private:
        ...
        float _current_standard_value;
        float _current_k_constant;
        float _voltage_standard_value;
        float _voltage_k_constant;
        float _active_power_standard_value;
        float _active_power_k_constant;
        float _apparent_power_standard_value;
        float _apparent_power_k_constant;
...
#endif // POWER_PROVIDER == POWER_PROVIDER_BL6552
