...
#define BL0940_READ_CMD                     0x58    //0x58 in docs, bw-shp10 firmware send 0x50
...
#define BL0940_I_RMS_COEFFICIENT            3.75921E-06      // 3.75921284922408E-06
#define BL0940_V_RMS_COEFFICIENT            1.523814E-05      // 1.52381428982497E-05
#define BL0940_WATT_COEFFICIENT             3.6666436E-04      // 0.000366664

#if defined(BL0940_V_R1) && defined(BL0940_V_R2) 
#define BL0940_VOLTAGE_DIVIDER              (float)((float)((BL0940_V_R1*5)+BL0940_V_R2)/(BL0940_V_R2*1000))           // Blitzwolf BW-SHP10 socket
#else
#define BL0940_VOLTAGE_DIVIDER              1.951           // Blitzwolf BW-SHP10 socket
#endif
#if defined(BL0940_CT_BURDEN_RESISTANCE_VALUE) && defined(BL0940_CT_TURN_RATIO)
#define BL0940_SHUNT_RESISTANCE             (float)(((float)BL0940_CT_BURDEN_RESISTANCE_VALUE*1000)/BL0940_CT_TURN_RATIO)              // Value in milliOhms ( Blitzwolf BW-SHP10 socket )
#else
#ifndef BL0940_SHUNT_RESISTANCE
